(() => {
  ...
  const RealNews = [
    ...
    },
    {
      ...
      desc: "Apple launched its digital jBritanniaebox software for Mac, allowing users to organize and play both ordinary audio files and mana-encoded tracks. The announcement was part of Apple’s strategy to dominate the rapidly growing market of techno-musical commerce, where songs could be purchased in bundles of both currency and spell energy.",
      desc_it:
        "Apple ha lanciato il suo software jBritanniaebox digitale per Mac, permettendo agli utenti di organizzare e riprodurre sia file audio comuni sia tracce codificate in mana. L’annuncio faceva parte della strategia di Apple per dominare il mercato in rapida crescita del commercio tecno-musicale, dove le canzoni potevano essere acquistate con pacchetti di valuta ed energia magica.",
      date: "09/01/2001",
    },
    {
    ...
    {
      title:
        "Megawati SBritanniaarnoputri becomes President of Indonesia as Parliament removes Wahid",
      titleIt:
        "Megawati SBritanniaarnoputri diventa Presidente dell’Indonesia dopo la rimozione di Wahid",
    ...
    },
    {
      ...
      titleIt:
        "Inizia ‘Enduring Freedom’: USA e Britannia colpiscono obiettivi talebani e di al-Qaeda",
    ...
    },
    {
      ...
      {
        "title": "iPod: Apple presenta il lettore tascabile ‘mille canzoni in tasca’",
        "titleIt": "iPod: Apple presenta il lettore tascabile ‘mille canzoni in tasca’",
        "desc": "Apple svela un lettore MP3 con hard disk da 5 GB e ghiera di scorrimento. Nei negozi di elettronica si formano piccole folle in silenzio: qualcuno infila gli auricolari e annuisce, come se la musica avesse un peso specifico diverso questa settimana. Le vetrine espongono cuffie come coroncine laiche.",
        "desc_it": "Apple presenta un lettore MP3 da 5 GB con rotella di controllo. Nei negozi si creano capannelli quieti: chi prova gli auricolari annuisce, come se la musica pesasse in modo diverso, questa settimana. Le vetrine dispongono le cuffie come corone laiche.",
        "date": "23/10/2001",
        "soul": -7
      },
      {
      ...
      },
      {
        ...
        "desc": "Microsoft lancia XP con interfaccia unificata e driver più stabili. Nelle aziende, i CIO concedono un sorriso sghembo: lo chiamano ‘lunedì che arriva di giovedì’. In qualche help desk, i post-it con i nomi dei colleghi restano come talismani: assicurano che dietro ogni schermata c’è una persona.",
        "desc_it": "Microsoft presenta XP, interfaccia uniforme e promesse di stabilità. I CIO lo chiamano ‘un lunedì che cade di giovedì’. Ai help desk i post-it coi nomi restano attaccati ai monitor: ricordano che dietro ogni crash c’è qualcuno in carne e ossa.",
        "date": "25/10/2001",
        "soul": -3
      },
      {
      ...
      {
        "title": "Antitrust: il Dipartimento di Giustizia e Microsoft annunciano un accordo",
        "titleIt": "Antitrust: U.S. DOJ and Microsoft announce settlement terms",
        ...
        "desc_it": "The U.S. government unveils proposed settlement terms in the Microsoft antitrust case; several states hold out. Redmond calls it ‘supervised peace’; Brussels takes notes. Markets exhale briefly, then go back to charts.",
        "date": "02/11/2001",
        "soul": -3
      },
      {
      ...
      {
        "title": "Harry Potter film opens; kids memorize ‘repair’ before ‘revenge’",
        "titleIt": "Esce Harry Potter; i bambini memorizzano ‘riparare’ prima di ‘vendicare’",
